      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'Naina Verma is a Product Designer with over 5 years of experience in creating user-centered designs. '
            ...
            const SizedBox(height: 12),
            ContactRow(icon: Icons.email, text: 'naina.verma_cs23@gmail.com'),
            ContactRow(icon: Icons.phone, text: '(555) 123-3696'),
            ContactRow(icon: Icons.link, text: 'linkedin.com/in/Naina Verma'),
          ],
        ),
      ),
    );
